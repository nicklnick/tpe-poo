...
public abstract class CustomButton extends ToggleButton {
    ...
    /*
     * Método utilizado para verificar que se este arrastrando el mouse en la dirección correcta.
     * No es llamado en LineButton y CircleButton pues se debe poder dibujar en cualquier dirección
     */
